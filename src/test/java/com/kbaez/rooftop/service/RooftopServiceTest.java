...
public class RooftopServiceTest {
	...
	@Test
	public void testGetTokenReturnTokenResponse(){
		TokenResponse tokenResponse = new TokenResponse();
		tokenResponse.setToken("e9371ae9-fde2-4c85-ab40-6cef5391586d");
		Mockito.when(restTemplate.getForObject(Mockito.any(String.class), Mockito.eq(TokenResponse.class))).thenReturn(tokenResponse);
		TokenResponse response = rooftopService.getToken("mail@gmail.com");
		assertEquals(tokenResponse, response);
	}
	
	@Test
	public void testGetBlocksReturnBlocksResponse(){
		BlocksResponse blocksResponse = new BlocksResponse();
		blocksResponse.setData(new String[] {
		                                       "F0gUU2TQPe9fg023U1vPFcwna7IQQyr362RNenYOa2ReTty1aoIh1mYHXB2jGkW825VBEQl2Xkr06AGiQguJbMysx2pWDcVtSdE8",
		                                       "KokzhmizqlWCXocJO1eXAuMW9JYx0Ba0HSW4TKnKtzI1chHoYQVXAKrF8go87g2c1CU1jjiRLiAi2hQs7IBn7huLokLKqFpZvFS4",
		                                       "SjkZvFcLV77eOWiuL4zkyJsdjgRGAu6dyyrVBkcmISKv0YJXWmQiJNnEzKzIcWnkW5yaKiCJ0SenSrYPuRQY2TE7Y6p5KpNugIBk",
		                                       "yJUg341qdmeEFuZqQCEFjfaM0zSVCt5mEliIdpjY0mBaiqqbojjy8J9BKiG9cPBFNfe8fRfttBemXnCmj4wXbj8Of04dGNwd5xER",
		...
		blocksResponse.setChunkSize("100");
		blocksResponse.setLength("900");
		Mockito.when(restTemplate.getForObject(Mockito.any(String.class), Mockito.eq(BlocksResponse.class))).thenReturn(blocksResponse);
		BlocksResponse response = rooftopService.getBlocks("e9371ae9-fde2-4c85-ab40-6cef5391586d");
		assertEquals(blocksResponse, response);
	}
}
